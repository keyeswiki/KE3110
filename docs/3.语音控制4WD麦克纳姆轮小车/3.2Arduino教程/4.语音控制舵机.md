...
舵机是一种位置伺服的驱动器，它能精确地旋转到指定的角度并保持住，这与普通电机一直旋转不同。在本课中，我们将结合之前学过的语音模块，让 Arduino 主控板接收语音指令，然后驱动一个 180° 舵机转动。
...
⚠️ **特别注意：语音控制智能小车已经组装好了，这里不需要把语音模块与舵机的线材拆下来又重新接线，这里再次提供接线图，是为了方便您编写代码。**
...
语音模块唤醒后，对着麦克风说：“舵机角度增大” 等命令词时，喇叭播放对应的回复语 “舵机角度已增大”，同时舵机从0°缓慢地转到180°位置；
